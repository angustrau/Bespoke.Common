...
namespace Bespoke.Common.Net
{
    ...
    public class TcpConnection : IDisposable
    {
        ...
        public TcpConnection(Socket client, bool littleEndianByteOrder = true)
        {
            ...
            Reader = new BinaryReader(mNetworkStream);
            Writer = new BinaryWriter(mNetworkStream);
        ...
        private void InitDataReceivedCallback()
        {
            ...
            Client.BeginReceive(mPartiallyReceivedData, 0, mPartiallyReceivedData.Length, SocketFlags.None, mDataReceivedCallback, null);
        }
